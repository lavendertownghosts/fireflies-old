<template>
  <div class="p-16 xl:px-40 max-w-screen-xl mx-auto">
    <LoadingLayerTransfersearch :request="request" />
    <!-- header & search -->
    <div class="relative overflow-hidden">
      ...
      <div>
        ...
        <div class="hidden md:block">
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full xl:w-4/7">
              <div class="flex flex-row mb-4" style="width: 492px">
                <div v-for="i in 3" :key="i" class="w-1/3 text-center">
                  <BaseSkeleton
                    :width="i === 3 ? '48px' : '81px'"
                    height="12px"
                    class="mr-10"
      ...
      <!-- sidebar & transfer cards -->
      <div class="w-full flex flex-row items-stretch mt-24">
        <div
          class="hidden lg:block lg:w-1/2 mr-8 min-w-grid-sm xl:min-w-grid-md"
        >
          <BaseSkeleton
            :height="responsiveTransferFilterHeight + 'px'"
            class="w-full mb-24"
          />
        </div>
        <div class="md:ml-8 flex-grow lg:w-1/2 overflow-hidden">
          ...
          <div class="flex flex-wrap justify-start">
            <div v-for="i in 5" :key="i" class="w-full mb-24">
              <BaseSkeleton
                :height="responsiveTransferImageHeight + 'px'"
                class="w-full"
              />
            </div>
          </div>
          <div class="w-full px-16 mb-40 flex md:justify-center">
            <BaseSkeleton height="40px" class="w-full md:w-2/3 lg:w-full" />
          </div>
        </div>
      </div>
    </div>
...
import LoadingLayerTransfersearch from '@/components/micro/LoadingLayerTransfersearch'

import {
  responsiveTransferImageHeight,
  responsiveTransferFilterHeight
} from '@/includes/utils'
...
export default {
  ...
  computed: {
    responsiveTransferImageHeight() {
      return responsiveTransferImageHeight()
    },
    responsiveTransferFilterHeight() {
      return responsiveTransferFilterHeight()
    },
    innerWidth() {
