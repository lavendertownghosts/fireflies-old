<template>
  ...
  >
    <div
      ...
      class="loading-layer-modal-wrapper bg-primary-gradient rounded text-white text-center p-16"
    >
      <p class="text-xs leading-12 pulse-me mt-32">
    ...
    computedSearchDestination() {
      if (
        ...
        return (
          this.request.from +
          '<i class="mx-4 far ' +
          (this.request.oneWay ? 'fa-long-arrow-right' : 'fa-exchange') +
          '"></i>' +
          this.request.to
        )
      } else {
