      ...
      <div class="bg-primary-gradient">
        ...
        >
          <div class="hidden md:block md:flex-initial md:mr-16">
            <img
              src="~assets/images/white-turq/travel-services/transfer/transfer-60.svg"
              class="w-60 h-60"
            />
          </div>
          <div class="flex-grow leading-32 md:leading-24">
            <div class="flex flex-wrap">
              <div class="flex-initial mr-4">
                <span class="cursor-help" :title="'Budapest'">{{ 'BUD' }}</span>
                <span
        ...
        <div class="flex flex-col md:flex-row items-stretch">
          <div class="w-auto md:mr-8 mb-40">
            ...
            <StatusMessage :type="'warning'" class="mt-16 leading-20">
              Kérjük, minden esetben tájékozódjon a speciális repülési
              feltételekről az adott légitársaság, illetve az érintett
              repülőterek oldalán.
              <br /><br />
              <span class="font-bold">FONTOS</span>: A megadott utasadatoknak
              egyeznie kell az utazási okmányban szereplő információkkal.
              Kérjük, ellenőrizze az itt látható adatok helyességét. A foglalás
              véglegesítését követően módosításra már nincs lehetőség.
            </StatusMessage>
            <ServicePreview
              :image-url="'/images/mercedes.svg'"
              :image-style="'bg-contain bg-no-repeat'"
              :image-height="'114px'"
              :date-text="
                '2019.10.15. - 2019.10.15. <span class=\'text-grey-dark\'>(8 éjszaka)</span>'
              "
              :room-text="false"
              class="mt-24 pt-16 md:hidden"
            >
              <div class="flex flex-col text-center mb-16">
                <div class="font-bold leading-16 text-black">
                  Mercedes E Class
                </div>
            ...
            <CartCard
              ...
              :price="acceptedBookingInformation ? 'EUR 493' : ''"
            ...
            <CartCard
              :type="openedCard.flightNumber ? 'success' : 'default'"
              :icon="
                openedCard.flightNumber
                  ? 'fas fa-check'
                  : 'fas fa-question text-primary'
              "
              :title="'Járatazonosító'"
              :active="activeCard === 'flightNumber'"
              class="mt-24"
              @showCartCard="showCartCard('flightNumber')"
            >
              <div class="flex flex-col px-16 pt-16 pb-12 mb-4 sm:flex-row">
                <InputText
                  v-model="flightNumberReturn"
                  :class="'w-full sm:mr-8 lg:w-240'"
                  :label="'Érkező járat azonosítója'"
                  :helper="'Időpont: 2019.10.15. (10:00)'"
                />
                <InputText
                  v-model="flightNumberDeparture"
                  :class="'w-full mt-24 sm:mt-0 sm:ml-8 lg:w-240'"
                  :label="'Induló járat azonosítója'"
                  :helper="'Időpont:  2019.10.22. (10:00)'"
                />
              </div>
            </CartCard>
            <CartCard
            ...
            >
              <div class="px-16 pt-18 pb-20 mb-4">
                <InputCheckbox v-model="copyContactAdult1">
                  <div class="text-sm leading-14 pt-2">
                ...
                <div class="mt-24 pt-24 border-t border-grey-light">
                  ...
                  <div class="flex flex-col lg:flex-row">
                    <div class="flex flex-row mt-24">
                      <InputDropdown
                        v-model="contact.phone.dialCode"
                        :values="dialCodeSelect"
                        :label="'Telefon'"
                        class="w-84 mr-8"
                      ></InputDropdown>
                      <InputText
                        v-model="contact.phone.number1"
                        :class="'w-52 mr-8 mt-12'"
                      />
                      <InputText
                        v-model="contact.phone.number2"
                        :class="'w-100 mt-12'"
                      />
                    </div>
                    <InputText
                      v-model="contact.email"
                      :class="'w-full mt-24 lg:w-240 lg:ml-16'"
                      :label="'Email'"
                    />
                  </div>
                  <div class="flex flex-col xl:flex-row">
          ...
          <div class="md:flex-shrink-0 md:ml-8 xl:w-288">
            <div
