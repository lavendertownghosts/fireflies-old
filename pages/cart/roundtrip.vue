        ...
        >
          ...
          <div class="flex-grow leading-32 md:leading-24">
            <div class="flex flex-wrap">
              <div class="mr-4">
                Andalusian Feelings with Madrid, Cultural Experience
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row items-stretch w-full">
          <div class="w-auto md:mr-8 mb-40">
            ...
            <ServicePreview
              ...
              :date-text="'2019.06.01. - 2019.06.08.'"
              :room-text="false"
              :car-text="'I don\'t need pick-up, I will meet you on location'"
              :info-text="
                'Single room | Superior Hotel Category | Vallnord-Pal Arinsal Ski Pass | Car Rental'
              "
  ...
  computed: {
    getServicePreviewImageHeight() {
      ...
      if (this.innerWidth >= 520 && this.innerWidth < 772) {
        height = '100%'
      } else if (this.innerWidth >= 772 && this.innerWidth < 1280) {
        height = '133px'
