    ...
    <div v-else class="text-black">
      <WebofficeBreadcrumb
        :links="[
          ...
          {
            name: $t('weboffice.DirectTravelContest'),
            link: '/weboffice/financial-data/direct-travel-contest'
          },
          {
      ...
      <StatusMessage type="warning">
        <div
          ...
          v-html="travelContest.localizedContents.importantMessageBox_title"
        ></div>
        <div
          class="text-sm leading-20"
          v-html="travelContest.localizedContents.importantMessageBox_message"
        ></div>
      </StatusMessage>
            ...
            >
              ...
              <tbody>
                <tr>
                  ...
                  <td class="py-13 px-8 border border-grey-light">
                    {{ travelContest.pointsNeedsToTravel }}
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div class="flex flex-col w-full mt-24">
        ...
        >
          <div
            v-if="
              travelContest.surroundedPeoplesTravelPoints.previous > 0 &&
                travelContest.surroundedPeoplesTravelPoints.next > 0
            "
            class="px-16"
          >
            <div
            ...
            <div class="px-16">
              ...
              >
                <div class="flex flex-row w-1/2">
                  <div class="w-16">{{ topItem.rank }}.</div>
            ...
            <tbody>
              <template v-for="(row, rowKey) in getDetailsTableData">
                ...
                >
                  ...
                  <td class="py-13 px-8 border border-grey-light">
                    {{ formatPoint(Math.round(row.amount * 100) / 100) }}
                  </td>
                  <td
                ...
                <tr v-show="activeKey === rowKey" :key="rowKey">
                  <td
                    colspan="6"
...
export default {
  ...
  methods: {
    async getDetails() {
      this.travelContest = await this.$store.dispatch(
        'user/getDirectTravelContest'
      )
      if (this.travelContest.topListresult !== undefined) {
        this.travelWinners = this.travelContest.topListresult.slice(0, 2)
        this.topList = this.travelContest.topListresult.slice(2)
  ...
  head() {
    return {
      title:
        this.$t('meta.WebofficeDirTravelContestTitle') +
