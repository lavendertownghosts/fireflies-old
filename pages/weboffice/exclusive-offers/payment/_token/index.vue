...
export default {
  name: 'ExclusiveOffersPaymentPage',
  ...
  methods: {
    ...
    paymentPending() {
      this.$router.replace(
        this.localePath('/weboffice/exclusive-offers/reservation-pending')
      )
    },
    paymentError() {
      this.$router.replace(
        this.localePath('/weboffice/exclusive-offers/reservation-failed')
      )
    }
  }
}
